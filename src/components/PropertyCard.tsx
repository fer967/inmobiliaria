...
// import React from 'react';
// import { MapPin, Home as ChevronRight, ImageOff } from 'lucide-react';
...
//                     <div className="w-full h-full flex flex-col items-center justify-center text-gray-400 p-8 text-center">
//                         <ImageOff size={40} className="mb-2 opacity-20" />
//                         <span className="text-xs font-medium">Imagen no encontrada en /public/images/</span>
//                     </div>
//                 )}
...
//                 <div className="absolute bottom-4 left-4">
//                     <div className="text-white text-3xl font-black drop-shadow-2xl">
//                         <span className="text-sm font-bold mr-1">{property.transaction === 'Compra' ? 'USD' : '$'}</span>
//                         {property.price.toLocaleString()}
//                     </div>
//                 </div>
//             </div>
